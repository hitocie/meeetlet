...
genres = [
  ...
  {:name => "洋食", :gcode => "200"},
  {:name => "中華", :gcode => "300"},
  {:name => "アジア・韓国・無国籍", :gcode => "400"},
  {:name => "カフェ", :gcode => "500"},
  {:name => "和食居酒屋", :gcode => "610"},
  {:name => "洋食居酒屋", :gcode => "620"},
  {:name => "アジア・韓国・無国籍居酒屋", :gcode => "630"},
  {:name => "ダイニングバー", :gcode => "640"},
  {:name => "バー", :gcode => "650"},
  {:name => "ファミレス・ファーストフード", :gcode => "800"}
]

for g in genres do
  Genre.new(:name => g[:name], :gcode => g[:gcode]).save!
end
